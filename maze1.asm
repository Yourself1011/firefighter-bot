...
AFSR0	EQU	4
AFSR0_H	EQU	5
SYSREADAD10WORD	EQU	69
SYSREADAD10WORD_H	EQU	71
...
ELSE26_2
	...
	btfss	SysTemp3,0
	goto	ELSE26_3
	pagesel	FN_WALLCHECKMIN
	call	FN_WALLCHECKMIN
	pagesel	$
	btfss	SYSBITVAR1,0
	goto	ELSE29_1
	movlw	6
